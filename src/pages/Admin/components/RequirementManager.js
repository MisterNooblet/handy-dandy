...
const RequirementManager = ({ target }) => {
    ...
    const getItemCategories = async () => {
        const categoryIds = await adminData.getItemCategories(target)
        console.log(categoryIds);
        toolDispatch({ type: 'setCategories', categories: categoryIds })
    }

    const getItemSubCategories = async () => {
        const subCategoryList = await adminData.getItemSubCategories(target, categories.currentCategory)
