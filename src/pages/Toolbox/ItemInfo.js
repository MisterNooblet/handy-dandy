...
const ItemInfo = ({ item }) => {
    ...
    return (
        <Box p={4} sx={{ flexGrow: 1, display: 'flex', flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'center' }}>
            ...
            <Box p={4} sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
